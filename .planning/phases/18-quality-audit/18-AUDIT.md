...
### Final counts (13 findings)

**By tag:** untested 6 (#1, #2, #4, #6, #7, #13) · value-wrong 4 (#5, #8, #9, #11) ·
value-misleading 2 (#3, #12) · untested→value-wrong hybrid 1 (#10 — vector coverage added,
closing the untested portion; the default-value divergence remains open).

**By severity:** — (coverage-only, no severity) 5 (#1, #2, #4, #6, #7) · minor 4 (#3, #9, #11,
#12) · moderate 2 (#5, #10) · major 2 (#8, #13).

**Fixed/resolved: 6** — #1, #2, #4, #6, #7 (external-reference vector coverage added, all pass
at 0.00% deviation, no engine change needed) and #12 (PPTX `formatIops()` precision fix,
regression-pinned).
