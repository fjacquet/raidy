...
- [ ] **Phase 16: PPTX Foundation** — Library integration, chart capture infrastructure, brand system, in-browser constraint
...
Plans:
- [ ] 14-01-PLAN.md — Patch low-risk packages (dompurify, recharts, zustand, fast-check, snyk, @types/node, tailwindcss)
...
| 14 - Dependency Maintenance | v1.3 | 0/3 | Not started | — |
