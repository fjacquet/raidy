...
| **Charts** | Centralized ECharts (SVG renderer), bundle-gated | D3-sankey + hand-rolled SVG gauges, donut and bars | raidy's visuals (capacity waterfall/Sankey, speedometers, donut) predate the convergence and are not worth a rewrite. Recharts was listed here until 2026-08-05, when the dead-code sweep found 8.5 MB of it unused and removed it. |
